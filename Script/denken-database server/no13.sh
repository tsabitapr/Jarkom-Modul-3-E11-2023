...
# agar bisa diakses oleh worker, ubah bind-address = 0.0.0.0
echo '
#
...
# masukkan syntax berikut untuk membuat database
...
# misal mau drop
# DROP USER 'kelompoke11'@'10.42.4.1';
# DROP USER 'kelompoke11'@'10.42.4.2';
# DROP USER 'kelompoke11'@'10.42.4.3';
